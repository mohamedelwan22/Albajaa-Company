import { generateTicketPDF } from "./dist/lib/pdf-generator.js";
import fs from "fs";
import path from "path";

// Mock ticket data matching MRS AYAT SALIH
const ticket = {
...
// Mock company data matching BAl Baja Company
const company = {
  name: "شركة البجع للسفر والسياحة",
  logoUrl: null, // this will trigger the local logo file loading and compression
  primaryColor: "#F7931E",
